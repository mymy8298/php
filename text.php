...
<form action="kq.php" method='post' class='quiz_form' id='quiz_form' accept-charset="utf-8">
	...
	<?php 
	$query = 'SELECT * FROM cauhoi Where MaDe ='.$_POST['sode'];
	...
	<div id="question_<?php echo $a;?>" class='questions'>
		<h2 id="question_<?php echo $a;?>"><?php echo $a.".".$result['ND'];?></h2>
			<div class='align'>
				<input type="radio" value="1" id='radio1_<?php echo $result['MaCH'];?>' name='<?php echo $result['MaCH'];?>'>
					<label id='ans1_<?php echo $a;?>' for='1'>
					<?php echo $result['A'];?></label>
						<br/>
				<input type="radio" value="2" id='radio2_<?php echo $result['MaCH'];?>' name='<?php echo $result['MaCH'];?>'>
					<label id='ans2_<?php echo $a;?>' for='1'>
					<?php echo $result['B'];?></label>
						<br/>
				<input type="radio" value="3" id='radio3_<?php echo $result['MaCH'];?>' name='<?php echo $result['MaCH'];?>'>
					<label id='ans3_<?php echo $a;?>' for='1'>
					<?php echo $result['C'];?></label>
						<br/>
				<input type="radio" value="4" id='radio4_<?php echo $result['MaCH'];?>' name='<?php echo $result['MaCH'];?>'>
...
?>
	...
	<br/>
		...
		<input type="submit" value='Nộp bài' name='kiemtra' class='butt'/>
	</div>
	<br/>
